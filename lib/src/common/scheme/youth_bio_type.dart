enum YouthBioType {
  ...
  binahStressLevel("binah_stress_level"),
  binahRecoverAbility("binah_recover_ability"),
  binahStressResponse("stress_response"),
  binahSns("binah_sns"),
  binahPns("binah_pns"),
  binahSnsZone("binah_sns_zone"),
  binahHypertensionRisk("binah_hypertension_risk"),
  binahWellnessIndex("binah_wellness_index"),
  binahWellnessLevel("binah_wellness_level"),
